...
var file_opencloud_services_policies_v0_policies_proto_rawDesc = []byte{
...
var (
	...
	file_opencloud_services_policies_v0_policies_proto_rawDescData = file_opencloud_services_policies_v0_policies_proto_rawDesc
)
...
func file_opencloud_services_policies_v0_policies_proto_rawDescGZIP() []byte {
	file_opencloud_services_policies_v0_policies_proto_rawDescOnce.Do(func() {
		file_opencloud_services_policies_v0_policies_proto_rawDescData = protoimpl.X.CompressGZIP(file_opencloud_services_policies_v0_policies_proto_rawDescData)
	})
...
var file_opencloud_services_policies_v0_policies_proto_goTypes = []interface{}{
...
func file_opencloud_services_policies_v0_policies_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_opencloud_services_policies_v0_policies_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_opencloud_services_policies_v0_policies_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_opencloud_services_policies_v0_policies_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_opencloud_services_policies_v0_policies_proto_rawDesc = nil
